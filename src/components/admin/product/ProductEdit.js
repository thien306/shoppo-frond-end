    ...
    const EditProduct = async (product) => {
        try {
            ...
            let dataRequest = {
                ...
                subCategory: product.subCategory ? product.subCategory.value : null,
                colors: colors,
                sizes: sizes,
                images: uploadedUrls,
                status: "ACTIVE",
                        ...
                        <Form>
                            ...
                            <div className="form-group">
                                ...
                                <Select
                                    ...
                                    value={brand.find(option => option.value === formik.values.brand.value)}
                            ...
                            <div className="form-group">
                                ...
                                <Select
                                    name="subCategory"
                                    options={subCategory}
                                    onChange={(option) => formik.setFieldValue("subCategory", option)}
                                    value={subCategory.find(option => option.value === formik.values.subCategory.value)}
